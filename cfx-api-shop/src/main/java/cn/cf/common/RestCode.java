...
public enum RestCode {
	...
	public static RestCode fromInt(String val) {
		...
		case "C024":
			return RestCode.CODE_C024;
		case "C025":
			return RestCode.CODE_C025;
		case "C026":
			return RestCode.CODE_C026;
		case "Z000":
		...
		case "D003":
			return RestCode.CODE_D003;
		case "D004":
			return RestCode.CODE_D004;
		case "D005":
			return RestCode.CODE_D005;
		case "D006":
			return RestCode.CODE_D006;
		case "D007":
			return RestCode.CODE_D007;
		case "P001":
	...
	public String toString() {
		...
		case "D002":
			return "收货地址不存在";
		case "D003":
			return "签收单位长度不能超过200位";
		case "D004":
			return "收货人长度不能超过20位";
		case "D005":
			return "手机号码格式错误";
		case "D006":
			return "收货地址长度不能超过800位";
		case "D007":
			return "收货地址不存在";
		case "P001":
			return "厂区已存在";
