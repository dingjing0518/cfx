 ...
 * @since 1.0
 * */
public class LogisticsErpBubbleStepInfoDtoEx  extends LogisticsErpBubbleStepInfoDto{
	/**
	 * 
	 */
	...
	public LogisticsErpBubbleStepInfoDtoEx(JSONObject js) {
		minTareWeight = js.containsKey("minTareWeight") ? js.getDouble("minTareWeight") : 0;
		maxTareWeight = js.containsKey("maxTareWeight") ? js.getDouble("maxTareWeight") : 0;
		coefficient=js.containsKey("coefficient")?js.getDouble("coefficient"):0;
	}
