...
<script src="./pageJs/manage/logsApiManage.js"></script>
<!-- 页面内容导航开始	-->
</head>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-lg-3 col-lg-2"><span>&nbsp;IP地址：</span>
					<input type="text"  name="ip" class="form-controlgoods" aria-controls="dynamic-table" />
					</label>
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								...
								<table id="operationLogsApiId" style="width: 100%"></table>
							</div>
						</div>
					</div>
				</div>
