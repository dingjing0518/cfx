...
<!-- 页面内容导航开始-->
<script src="./pageJs/logistics/report/supplierDataReport.js"></script>
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading" style="margin-bottom:10px;">
						<label class="col-lg-2 col-lg-3"><span>物流承运商：</span> <input class="form-controlgoods input-append " type="text" name="logisticsCompanyName"   value="" onkeydown="entersearch()"/></label>	
		          ...
		          <button style="display:none;" showname="LG_REPORT_SUPP_BTN_EXPORT" class="btn btn-success dropdown-toggle" onclick="exportReport();" data-toggle="dropdown">导出 </button>
             	</header>
					...
					<section class="panel">
                        <header class="panel-heading custom-tab ">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#all" data-toggle="tab" onclick="findSupplierDataStatus('');">全部</a>
                                </li>
                                <li class="">
                                    <a href="#off-shelve" data-toggle="tab" onclick="findSupplierDataStatus(1);">未结算</a>
                                </li>
                                <li class="">
                                    <a href="#off-shelve" data-toggle="tab" onclick="findSupplierDataStatus(2);">已结算</a>
                                </li>
                                <li class="">
                                    <a href="#off-shelve" data-toggle="tab" onclick="findSupplierDataStatus(3);">异常</a>
                                </li>
                            </ul>
                        </header>
