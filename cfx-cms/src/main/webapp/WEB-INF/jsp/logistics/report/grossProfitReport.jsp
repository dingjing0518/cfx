...
<!-- 页面内容导航开始-->
<script src="./pageJs/logistics/report/grossProfitReport.js"></script>
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading" style="margin-bottom:10px;">
						<label class="col-lg-2 col-lg-3"><span>物流供应商：</span> <input class="form-controlgoods input-append " type="text" name="logisticsCompanyName"   value="" onkeydown="entersearch()"/></label>	
<!-- 						<label class="col-lg-2 col-lg-3"><span>联系电话：</span> <input class="form-controlgoods input-append " type="text" name="logisticsContacts"   value="" onkeydown="entersearch()"/></label>	
 -->						<label class="col-lg-2 col-lg-3"><span>订单号：</span> <input class="form-controlgoods input-append " type="text" name="orderPk"   value="" onkeydown="entersearch()"/></label>	
						
						<label class="col-lg-2 col-lg-3"><span>订单时间：</span> <input class="form-controlgoods input-append form-dateday form-dateday_start" type="text" name="insertStartTime"   value="" onkeydown="entersearch()"  readonly /></label>
		          ...
		          <button style="display:none;" showname="LG_REPORT_GP_BTN_EXPORT" class="btn btn-success dropdown-toggle" onclick="exportReport();" data-toggle="dropdown">导出 </button>
             	</header>
					...
					<section class="panel">
                        ...
                        <div class="panel-bodycommon">
                            <div class="tab-content">
                                ...
                                <table id="grossProfitId" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
