...
<script src="./pageJs/economics/creditReportGoods.js"></script>
<style>
...
<body class="sticky-header">
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								<!-- 模态框 -->
								<button id="editable-sample_new" class="btn btn-primary btn-new" style="display:none;" showname="EM_ECONOMICS_CRECHEMG_GOODSMG_BTN_ADD"
									data-toggle="modal" onclick="javascript:edit();">
									新增<i class="fa fa-plus"></i>
								</button>
								<table id="creditReportGoodsTable" style="width: 100%"></table>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="editCreditReportGoods" tabindex="-1" role="dialog"
