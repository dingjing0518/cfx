...
<script src="./pageJs/economics/economicsCustomerManage.js"></script>
<style>
.modal-backdrop.in {
	z-index: 100;
}
...
<body class="sticky-header">
	...
	<div class="wrapper">
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="left">
					<label class="col-lg-2 col-lg-2"><span>公司名称：</span> <input
						class="form-controlgoods input-append " type="text"
						name="companyName" value="" onkeydown="entersearch()" /></label> 
						<label
				...
				<button class="btn btn-warning" id="btn" onclick="SearchClean(2)">
					清除</button>
				<button style="display:none;" showname="EM_CUST_APPLY_BTN_ALLIMPORT"  class="btn btn-primary" onclick="importDatumFile('','')">
						批量导入</button>
				<button  class="btn btn-primary"  style="display:none;" showname="EM_CUST_APPLY_MG_BTN_ALLEXPORT" onclick="exportAllDatumFile()">
						批量导出</button>	
					</div>
				</header>
	...
	<div class="modal fade" id="importDatumId" tabindex="-1" role="dialog"
		 aria-labelledby="myModalLabel" style="z-index: 1050">
		<div class="modal-dialog" role="document" style="width: 500px;">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
							aria-label="Close" id="quxiaoModal">
						<span aria-hidden="true">&times;</span>
					</button>
					<h4 class="modal-title">分值导入</h4>
					<input type="hidden" id="importCompanyPk"/>
					...
					<form   id="dataPriceTrendHistoryForm">
						...
						<div class="form-group col-ms-12"
							...
							<label for="inputEmail3" class="col-sm-3 control-label"
								   style="text-align: left;">评分文件</label>
							<div class="col-sm-9">
...
<div class="modal fade" id="exportFileId" tabindex="-1" role="dialog"
		 aria-labelledby="myModalLabel" style="z-index: 1050">
		<div class="modal-dialog" role="document" style="width: 500px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<input type="hidden" id="econCustmerPk"/>
				...
				<div class="modal-body">
					<form   id="dataPriceTrendHistoryForm">
						...
						<div class="form-group col-ms-12"
							 style="height: 30px; display: block;">
							<label for="inputEmail3" class="col-sm-3 control-label"
								   style="text-align: left;">文件类型：</label>
							<div class="col-sm-9">
								<label><input name="fileType" type="radio" value="XLS" checked='checked' style="margin-left:3px;" />XLS</label>
								<label><input name="fileType" type="radio" value="TXT" style="margin-left:3px;"/>TXT</label>
								<label><input name="fileType" type="radio" value="CSV" style="margin-left:3px;"/>CSV</label>
							</div>
						</div>
					</form>
				</div>
				...
				<div class="modal-footer" style="margin-top:-15px;">
					<button type="button" class="btn btn-primary" onclick="submitExport();">确定</button>				
					<button type="button" class="btn btn-default" id="quxiaoExport" data-dismiss="modal">取消</button>
				</div>
		</div>
	</div>
	</div>
	<div class="modal fade" id="exportAllFileId" tabindex="-1" role="dialog"
		 aria-labelledby="myModalLabel" style="z-index: 1050">
		<div class="modal-dialog" role="document" style="width: 500px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<form   id="dataPriceTrendHistoryForm">
						...
						<div class="form-group col-ms-12"
							...
							<label for="inputEmail3" class="col-sm-3 control-label"
								   style="text-align: left;">文件类型：</label>
							<div class="col-sm-9">
								<label><input name="allfileType" type="radio" value="XLS" checked='checked' style="margin-left:3px;" />XLS</label>
								<label><input name="allfileType" type="radio" value="CSV" style="margin-left:3px;"/>CSV</label>
							</div>
						</div>
					</form>
				</div>
				...
				<div class="modal-footer" style="margin-top:-15px;">
					<button type="button" class="btn btn-primary" onclick="submitAllExport();">确定</button>				
					<button type="button" class="btn btn-default" id="quxiaoAllExport" data-dismiss="modal">取消</button>
				</div>
		</div>
	</div>
	</div>
