						...
						<section class="panel">
							...
							<div class="shenpimessage">
								...
								<ul>
									...
									<li style="width:auto;"><span>申请时间：</span><fmt:formatDate value="${economicsCustDto.insertTime }" pattern="yyyy-MM-dd HH:mm:ss"/></li>
								...
								<c:forEach items="${economicsCustDto.goodsList}" var="dimen" > 
									<ul>
										...
										<c:if test="${dimen.goodsType == 2||dimen.goodsType == 4}"><!-- 化纤贷含七天利率 -->
											...
											<li class="width18"><span>建议额度：</span><input type="text" onkeyup="format_input_num(this)"   maxlength="15" name="limit_d" required="true"  />&nbsp;&nbsp;W</li>
											<li class="width25">
												<span>有效时间：</span>
												<input class="form-controlgoods form-dateday responsive" type="text" name="effectStartTime_d"  value="" />
												<span style="width:auto;">至</span>
												<input class="form-controlgoods form-dateday responsive" type="text"  name="effectEndTime_d"  value="" />
											</li>
											<li class="width25"><span>总利率：</span><input type="text"   maxlength="10" name="totalRate_d" required="true"  />&nbsp;&nbsp;</li>
											<br/>
											<li class="width18"><span>银行利率：</span><input type="text"   maxlength="10" name="bankRate_d" required="true"  />&nbsp;&nbsp;</li>
											<li class="width25"><span>期限：</span><input type="text" onkeyup="format_input_num(this)"   maxlength="10" name="term_d" required="true"  />&nbsp;&nbsp;</li>
			     							<li><span>七天利率：</span><input type="text"   maxlength="10" name="sevenRate" required="true"  />&nbsp;&nbsp;</li>
										</c:if>
										<c:if test="${dimen.goodsType == 1||dimen.goodsType == 3}"><!-- 化纤白条 -->
											<input type="hidden" name="econGoodsPk_bt" value="${dimen.pk}" />
											<input type="hidden" name="productName_bt" value="${dimen.economicsGoodsName}" />
											<li class="width18"><span>建议额度：</span><input type="text" onkeyup="format_input_num(this)"   maxlength="15" name="limit_bt" required="true"  />&nbsp;&nbsp;W</li>
											<li class="width25">
											<span>有效时间：</span>
											<input class="form-controlgoods form-dateday responsive" type="text" name="effectStartTime_bt"  value="" />
											<span style="width:auto;">至</span>
											<input class="form-controlgoods form-dateday responsive" type="text"  name="effectEndTime_bt"  value="" />
											</li>
											<li class="width25"><span>总利率：</span><input type="text" maxlength="10" name="totalRate_bt" required="true"  />&nbsp;&nbsp;</li>
											<br/>
											<li class="width18"><span>银行利率：</span><input type="text"   maxlength="10" name="bankRate_bt" required="true"  />&nbsp;&nbsp;</li>
											<li class="width25"><span>期限：</span><input type="text" onkeyup="format_input_num(this)"   maxlength="10" name="term_bt" required="true"  />&nbsp;&nbsp;</li>
										</c:if>
										<li class="suyh">
							...
							<div class="datalist datalistnew">
								...
								<ul>
									...
									<li class="showright" ><span id ="rawAnnualizAmount"></span><span class="spanright" id ="rawAnnualizAmountScore"></span></li>
								</ul>
								<ul>
