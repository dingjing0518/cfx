											...
											<input type="hidden" name="billGoodsPk" value="${dimen.pk} " />
		     								<div  style="margin-left:12px;float:left">
												<p style="float: left;line-height: 34px;">建议额度：</p>
													<input type="text" class="form-control responsive" name="limit" onkeyup="format_input_num(this)"   maxlength="15" required="true" style="float:left;width:130px" value= "<fmt:formatNumber value="${dimen.suggestAmount}" pattern="##.##"/>">
