...
<script src="./pageJs/yarn/opermg/yarnPriceTrendHistory.js"></script>
<style>
				...
				<section class="panel">
				 <header class="panel-heading" style="margin-bottom:10px;">	
			            ...
			            <button class="btn btn-primary" id="btn" onclick="SearchClean(1);"> 搜索</button>
			             ...
			             <button  style="display:none;" showname="YARN_MG_HOMESHOW_PRICEHIST_BTN_EXPORT" class="btn btn-primary" id="btn" onclick="exportHistory();">导出</button>
		             </header>
		             <!--  -->
			...
			<div class="modal-content">
				...
				<form   id="dataForm">
					...
					<div class="form-group col-ms-12"
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="yarnPrice" name="yarnPrice" style="width: 342px;" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group col-ms-12"
						style="height: 30px; display: block;">
