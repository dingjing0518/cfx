...
<script src="./pageJs/yarn/yarnmg/homeMaterial.js"></script>
<style>
		...
		<div class="row">
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-lg-3 col-lg-2 selectclose"><span>&nbsp;原料：</span>
						<select name="rawMaterialPk" class="selectpicker bla bla bli">
							
							<option value="">--请选择--</option>
							<c:forEach  var ="c" items="${noIsVisMaterialList }" >
							<option value="${c.pk }">${c.name }</option>
							</c:forEach>
						</select> 
					</label>
					<label class="col-lg-3 col-lg-2 selectclose"><span>&nbsp;是否启用：</span>
		  ...
		  <button class="btn btn-primary" id="btn" onclick="Search();"> 搜索</button>
					...
					<button id="editable-sample_new" style="display:none;" showname="YARN_OPER_SHOW_RAWMAT_BTN_ADD" class="btn btn-primary"
						data-toggle="modal" data-target="#editHomePageProductNameId"
						onclick="javascript:editHomeMaterialBanner('','','',''); ">添加原料</button>
				</a> </header>
				<div class="panel-body">
					...
					<div class="panel-body">
						<div class="tab-content">
							...
							<table id="homeMaterialBannerId" style="width: 100%"></table>
						</div>
					</div>
					</section>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑首页原料</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
					<form class="form-horizontal" id="dataForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="rawMaterialPk" id="rawMaterialPk" required="true">
									<option value="">--请选择--</option>
									<c:forEach  var ="c" items="${noIsVisMaterialList}" >
										<option value="${c.pk }">${c.name }</option>
									</c:forEach>
