...
<script src="./pageJs/yarn/goodsmgr/rawmaterial.js"></script>
<!-- 页面内容导航开始-->
</head>
				...
				<header class="panel-heading" style="margin-bottom:10px;">
					...
					<label class="col-lg-3 col-lg-2"><span>添加时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertTimeStart"   value="" readonly /></label>
			           <label class="col-lg-3 col-lg-2"><span>至：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertTimeEnd"   value="" readonly /></label>	     	
					     <label class="col-lg-2 col-lg-3"><span>&nbsp;原料名称：</span> 
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								<!-- 模态框 -->
								<button id="editable-sample_new" style="display:none;" showname="YARN_GOODS_SETTING_RAWMAT_BTN_ADD" class="btn btn-primary btn-new"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form id="dataForm">
					...
					<div class="form-group col-ms-12"
						 style="height: 30px; display: block;">
						<label for="inputEmail3" class="col-sm-2 control-label" style="text-align: left;">是否混纺</label>
						<div class="col-sm-5">
							<label>是<input name="isBlend" type="radio" value="1" checked='checked' style="margin-left:3px;" /></label>
							<label>否<input name="isBlend" type="radio" value="2" style="margin-left:3px;"/></label>
						</div>
					</div><!-- 编辑页面结束 -->
						<div class="form-group col-ms-12"
							style="height: 30px; display: block;">
