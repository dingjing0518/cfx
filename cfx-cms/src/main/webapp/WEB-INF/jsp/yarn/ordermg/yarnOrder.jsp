...
<script src="./pageJs/yarn/ordermg/yarnOrder.js"></script>
<!-- 页面内容导航开始-->
</head>
				...
				<section class="panel">
					<header class="panel-heading">
					   ...
					   <select class="form-controlgoods input-append " name="paymentType" style="width: 110px;">
						...
						<input type = "hidden" id="block" name="block" value="sx"/>
			            ...
			            <button style="display:none;" showname="YARN_ORDER_BTN_EXPORT" class="btn btn-default dropdown-toggle" onclick="getOrderGoods();" data-toggle="dropdown"><span id="loadingExportData">导出</span></button>
		            	<button style="display:none;" showname="YARN_ORDER_BTN_ORDEREXPORT" class="btn btn-default dropdown-toggle" onclick="getOrder();" data-toggle="dropdown"><span id="loadingExportOrderData">订单导出</span></button>
