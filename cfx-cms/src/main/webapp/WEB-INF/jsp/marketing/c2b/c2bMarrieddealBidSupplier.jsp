...
<script src="./pageJs/marketing/c2b/c2bMarrieddealBidSupplier.js"></script>
<!-- 页面内容导航开始-->
</head>
				...
				<section class="panel">
					...
					<button class="btn btn-primary" id="btn" onclick="searchTabs(2);">
						清除
							...
							<button id="editable-sample_new" style="display:none;" showname="BTN_EXPORTRECOMMENDSUPPIER" class="btn btn-primary"
									data-toggle="modal" onclick="javascript:exportsBidSupplier();">
									导出
								</button>		
					<!-- 	<button id="editable-sample_new" class="btn btn-primary"
									data-toggle="modal" onclick="javascript:addSupplier();">
									新增推荐供应商
								</button>		 -->
					...
					<section class="panel">
                        <header class="panel-heading custom-tab ">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#all" data-toggle="tab" onclick="searchReqx(-2);">全部</a>
                                </li>
                                 <!--  <li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="searchReqx(0);">未匹配</a>
                                </li> -->
                               <li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="searchReqx(1);">系统匹配</a>
                                </li>
                                 <li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="searchReqx(2);">人工匹配</a>
                                </li>  
                            </ul>
                        </header>
...
<!-- 报价信息quotedPriceId -->
			...
			<div class="form-group col-ms-12">
					...
					<div class="modal-footer">
						...
						<label class="col-sm-6 col-md-4 col-lg-3"><span>规格：</span>
							<select name="specPk" id="specPk"  class="selectpicker bla bla bli"   data-live-search="true" onchange="AddChangeSpec()">
					          	 	<option value="">--请选择--</option>
	...
	<div class="modal fade" id="supplierTrackRecordId" tabindex="-1" role="dialog"
		aria-labelledby="noAuditModalLabel" style="z-index: 1050">
		<div class="col-sm-12">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
			...
			<form id="dataForm">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="submitSupplierTrack();">保存</button>
				</div>
					</header>
				<div class="panel-body">
					<section class="panel">
	...
	<!-- 报价管理子页面 -->
	<div class="modal fade" id="supplierQuotedPriceManageId" tabindex="-1" role="dialog"
		aria-labelledby="noAuditModalLabel" style="z-index: 1050">
		<div class="col-sm-10">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
				...
				<section class="panel">
					<header class="panel-heading" > 
						...
						<label class="col-sm-6 col-md-4 col-lg-3"><span>采购商名称：</span> <input class="form-controlgoods input-append " type="text" name=bpurchaserName   value="" /></label>
						...
						<label class="col-sm-6 col-md-4 col-lg-3"><span>审核时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertStartTimes"   value="" readonly /></label>
			           	<label class="col-sm-6 col-md-4 col-lg-3"><span>至：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertEndTimes"   value="" readonly /></label>
			           	<label class="col-sm-6 col-md-4 col-lg-3"><span>发布时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="paymentStartTimes"   value="" readonly /></label>
			           	<label class="col-sm-6 col-md-4 col-lg-3"><span>至：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="paymentEndTimes"   value="" readonly /></label>
