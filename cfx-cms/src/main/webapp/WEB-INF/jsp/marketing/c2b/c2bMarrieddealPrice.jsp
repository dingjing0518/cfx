...
<script src="./pageJs/marketing/c2b/c2bMarrieddealPrice.js"></script>
<!-- 页面内容导航开始-->
<style >
					...
					<section class="panel">
                        <header class="panel-heading custom-tab ">
                            <ul class="nav nav-tabs">
                               ...
                               <li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="findMarri(9);">等待报价</a>
                               </li>
                                <!--<li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="findMarri(2);">已经报价</a>
                                </li> -->
                                 <li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="findMarri(1);">已中标</a>
                                </li> 
                                <li class="">
                                    <a href="#unverify" data-toggle="tab" onclick="findMarri(0);">已过期</a>
                                </li>  
                            </ul>
                        </header>
					...
					<input type="hidden" class="form-control" id="pk" />
						...
						<div class="form-group col-ms-12"
							...
							<div class="col-sm-5" style="margin-left:-22px;">
							  <select id="purchaserName" name="purchaserName" class="selectpicker bla bla bli"   required="true"  onchange="getCompanyByPk()">
					          	 	<option value="">--请选择--</option>
