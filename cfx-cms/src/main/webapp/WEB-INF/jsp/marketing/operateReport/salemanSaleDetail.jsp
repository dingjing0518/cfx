...
<script src="./pageJs/marketing/operateReport/salemanSaleDetail.js"></script>
<style>
.form-controlgoods{
float:left;
width:200px;
...
<body class="sticky-header">
	<div class="page-heading">
		<ul class="breadcrumb">
			<li><a href="#">营销中心</a></li>
			<li class="active">数据管理>业务员交易明细</li>
		</ul> 
	</div>
	<!-- 页面内容导航结束-->
	<!--主体内容开始-->
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading">
			          ...
			          <button style="display:none;" showname="MARKET_REPORT_SALEMANSALEDETAIL_BTN_EXPORT" class="btn btn-primary" onclick="exportData();" data-toggle="dropdown"><span id="loadingExportData">导出</span></button>
		             </header>
                        ...
                        <div class="panel-bodycommon">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="unverify">
                                 ...
                                 <table id="salemanSaleDetail" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
