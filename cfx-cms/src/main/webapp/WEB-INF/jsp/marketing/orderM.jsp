...
<script src="./pageJs/marketing/orderM.js"></script>
					...
					<header class="panel-heading">
				      ...
				      <!--  <label class="col-lg-3 col-lg-2"><span>采购商账号：</span> <input class="form-controlgoods input-append " type="text" name="mobile"   value="" /></label> -->
			           ...
			           <label class="col-lg-3 col-lg-2"><span>至：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertEndTime"   value="" readonly /></label>
			            <label class="col-lg-3 col-lg-2"><span>订单来源：</span> <select class="form-controlgoods input-append " name="source">
					 ...
					 <label class="col-lg-3 col-lg-2"><span>收款时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="receivablesStartTime"   value="" readonly /></label>
			           <label class="col-lg-3 col-lg-2"><span>至：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="receivablesEndTime"   value="" readonly /></label>
					   <label class="col-lg-3 col-lg-2"><span>支付方式：</span> 
					   <select class="form-controlgoods input-append " name="paymentType">
					   		<option value="">全部</option>
			           ...
			           <button style="display:none;" showname="MARKET_ORDER_BTN_ORDER_EXPORT" class="btn btn-default dropdown-toggle" onclick="excel();" data-toggle="dropdown"><span id="loadingExportData">导出</span></button>
		             </header>
                        ...
                        <div class="panel-bodycommon">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="unverify">
                                 ...
                                 <table id="orderMId" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
