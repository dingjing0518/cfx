...
<!-- 页面内容导航开始-->
<script src="./pageJs/marketing/supplierM.js"></script>
<style>
...
<body class="sticky-header">
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading" style="margin-bottom:10px;">
								    <label class="col-lg-2 col-lg-3"><span>店铺名称：</span> <input class="form-controlgoods input-append " type="text" name="name"   value="" onkeydown="entersearch()"/></label>   
                                <label class="col-lg-2 col-lg-3"><span>电话：</span> <input class="form-controlgoods input-append " type="text" name="mobile"   value="" onkeydown="entersearch()"/></label>   
                                ...
                                <label class="col-lg-3 col-lg-2 addressnew" style="width: 18%;position: relative;z-index: 9;"><span>所在地区：</span> 
					...
					<section class="panel">
                        <div class="panel-bodycommon">
                            <div class="tab-content">
                                ...
                                <table id="supplierMId" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
	...
	<input type="hidden" id="isShow" value="${isShowF}"/>
	<!-- 图片放上去显示js -->
	<script>
