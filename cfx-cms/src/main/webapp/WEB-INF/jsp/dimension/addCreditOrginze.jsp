...
<script src="./pageJs/dimension/creditOrginze.js"></script>
<style>
#dtblock1 .help-block {
	margin-right: 585px;
	position: absolute;
						...
						<table class="table table-bordered table-striped table-condensed">
							<tbody>
								<tr style="position: relative">
									<td class="col-sm-1" style="text-align: right;">授信机构数:</td>
									<td class="col-sm-8" style="position: relative;">
										<div id="dtblock1">
											<input type="text" class="form-control"
												style="width: 180px; float: left;" name="minCount"
												maxlength="8" id="minCount" value="${economics.minCount}"
												required="true" />
										</div> <span style="margin-left: 20px;"> &lt;授信机构数&le;=</span>
										<div id="dtblock2">
											<input type="text" class="form-control"
												style="width: 180px; margin-top: -30px; margin-left: 320px;"
												name="maxCount" maxlength="8" id="maxCount"
