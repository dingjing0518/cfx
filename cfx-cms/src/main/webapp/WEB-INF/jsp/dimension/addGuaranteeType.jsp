...
<head>
    ...
    <script src="./pageJs/dimension/guaranteeType.js"></script>
    <style>
        #dtblock1 .help-block{
            margin-right: 585px;
		    position: absolute;
            ...
            <section class="panel">
                ...
                <form id="dataForm">
                    ...
                    <div class="panel-body" id="unseen"><input type="hidden" id="pk"
                                                               name="pk" value="${guaranteeType.pk}"/>
                        <table class="table table-bordered table-striped table-condensed">
                            <tbody>
                            <tr>
                                <td class="col-sm-1" style="text-align: right;">担保分类:</td>
                                <td class="col-sm-8">
                                    <input type="radio" name="type"  id="type" value="关注类"  ${guaranteeType.type=='关注类'?' checked="checked"':''} />关注类

                                </td>
                            </tr>
                            <tr style="position:relative">
                                <td class="col-sm-1" style="text-align: right;">担保金额 :</td>
                                <td class="col-sm-8" style="position:relative;"><div id="dtblock1"><input type="text"
                                                            ...
                                                            value="${guaranteeType.minNumber}" required="true"/></div>
                                     <div style="width: 30px;display: inline-block;margin-left: 10px;">w</div> 
                                    <span style="margin-left: -14px;"> &lt;担保金额 &le;</span>
                                    <div id="dtblock2">
                                    <input type="text"
                                           class="form-control" style="width: 180px;margin-top: -30px;margin-left: 300px;"
                                           name="maxNumber" id="maxNumber" maxlength="8"
                                           value="${guaranteeType.maxNumber}" required="true"/>
                                   <div style="width: 30px;display: inline-block;margin-left: 490px;margin-top: -34px;">w</div>
                            ...
                            <tr id="dtblock3">
                                ...
                                <td class="col-sm-5" style="position:relative">
                                    <input type="text"
                                           ...
                                           name="score" id="score"
                                           value="${guaranteeType.score}" maxlength="8" required="true"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
