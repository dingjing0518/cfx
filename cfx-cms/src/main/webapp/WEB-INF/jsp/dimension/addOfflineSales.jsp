...
<head>
    ...
    <script src="./pageJs/dimension/offlineSales.js"></script>
     <style>
        #dtblock1 .help-block{
            margin-right: 585px;
		    position: absolute;
                            ...
                            <tr id="dtblock3">
                                ...
                                <td class="col-sm-5" style="position:relative">
                                    <input type="text"
                                           ...
                                           name="score" id="score"
                                           value="${offlineSales.score}" maxlength="8" required="true"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
