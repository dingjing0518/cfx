        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading" style="margin-bottom:10px;">
                    ...
                    <%--<label class="col-lg-2 col-lg-3"><span>状态:</span> <select class="form-controlgoods input-append " name="isOpen" style="width: 110px;"><option value="">全部</option><option value="1">启用</option><option value="2">禁用</option></select></label>--%>
                    ...
                    <button id="editable-sample_new" style="display:none;" showname="BTN_ADDCAPACITY" class="btn btn-primary" data-toggle="modal" data-target="#myModal1" onclick="javascript:editOfflineScale('');">新增</button>
                    <%--</a>--%>
                </header>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="all">
                                    <table id="OfflineScaleListId" style="width: 100%"></table>
                                </div>
                            </div>
                        </div>
                    </section>
