        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading" style="margin-bottom:10px;">
                    ...
                    <button id="editable-sample_new" style="display:none;" showname="BTN_ADDCAPACITY" class="btn btn-primary" data-toggle="modal" data-target="#myModal1" onclick="javascript:editOfflineInvoice('');">新增</button>
                </header>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="all">
                                    <table id="OfflineInvoiceListId" style="width: 100%"></table>
                                </div>
                            </div>
                        </div>
                    </section>
