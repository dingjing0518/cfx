...
<script src="./pageJs/finance/orderF.js"></script>
<style >
					...
					<header class="panel-heading">
				     ...
				     <!--   <label class="col-lg-3 col-lg-2"><span>采购商账号：</span> <input class="form-controlgoods input-append " type="text" name="mobile"   value="" /></label> -->
					   ...
					   <select class="form-controlgoods input-append " name="paymentType" style="width: 110px;">
			             ...
			             <input type = "hidden" name="economicsGoodsType" value = "2"/>
						<input type = "hidden" id="block" name="block" value="cf"/>
 		            	...
 		            	<button style="display:none;" showname="FC_ODER_MGR_BTN_ORDEREXPORT" class="btn btn-default dropdown-toggle" onclick="getOrder();" data-toggle="dropdown"><span id="loadingExportOrderData">导出</span></button>
