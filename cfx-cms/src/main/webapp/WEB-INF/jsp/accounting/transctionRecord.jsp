...
<!-- 页面内容导航开始-->
<script src="./pageJs/transctionRecord.js"></script>
</head>
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading" style="margin-bottom:10px;">
								...
								<label class="col-sm-6 col-md-4 col-lg-3"><span>交易状态：</span> <select class="selectpicker bla bla bli " name="status"><option value="">--请选择--</option><option value="1">成功</option><option value="2">失败</option></select></label>	
					...
					<section class="panel">
                        <div class="panel-bodycommon">
                            <div class="adv-table editable-table">
                                ...
                                <table id="transctionRecord" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
