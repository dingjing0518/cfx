...
<script src="./pageJs/operation/order.js"></script>
<!-- 页面内容导航开始-->
</head>
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading">
			            <label class="col-lg-3 col-lg-2"><span>订单编号：</span> <input class="form-controlgoods input-append " type="text" name="orderNumber"   value="" onkeydown="entersearch()"/></label>	
				       <label class="col-lg-3 col-lg-2"><span>采购商名称：</span> <input class="form-controlgoods input-append " type="text" name="purchaserName"   value="" onkeydown="entersearch()"/></label>	     	
				     <!--   <label class="col-lg-3 col-lg-2"><span>采购商账号：</span> <input class="form-controlgoods input-append " type="text" name="mobile"   value="" /></label> -->
				       <label class="col-lg-3 col-lg-2"><span>下单时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertStartTime"   value="" readonly /></label>
				       ...
				       <label class="col-lg-3 col-lg-2"><span>店铺：</span> <input class="form-controlgoods input-append " type="text" name="storeName"   value="" onkeydown="entersearch()"/></label>	     	
				       <label class="col-lg-3 col-lg-2"><span>订单来源：</span> <select class="form-controlgoods input-append " name="source" style="width: 110px;">
				       		<option value="">全部</option>
				       		<option value="1">pc端</option>
				       		<option value="2">移动端</option>
				       		<option value="3">app</option>
				       	</select></label>	     	
			           <label class="col-lg-3 col-lg-2"><span>支付时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="paymentStartTime"   value="" readonly /></label>
			           <label class="col-lg-3 col-lg-2"><span>至：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="paymentEndTime"   value="" readonly /></label>
					   <label class="col-lg-3 col-lg-2"><span>支付方式：</span> 
					   <select class="form-controlgoods input-append " name="paymentType" style="width: 110px;">
					   		<option value="">全部</option>
			            ...
			            <button style="display:none;" showname="OPER_ORDER_BTN_EXPORT" class="btn btn-default dropdown-toggle" onclick="getOrderGoods();" data-toggle="dropdown"><span id="loadingExportData">导出</span></button>
		            	<button style="display:none;" showname="OPER_ORDER_BTN_ORDEREXPORT" class="btn btn-default dropdown-toggle" onclick="getOrder();" data-toggle="dropdown"><span id="loadingExportOrderData">订单导出</span></button>
...
<div class="modal fade" id="payMentVoucherId" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document" style="width: 25%;height: 500px;">
			<div class="modal-content">
					...
					<div class="form-group col-ms-12" style="height:90px;width:100px; display: block;">
					  ...
					  <div class="form-group col-ms-12"
						...
						<label for="inputEmail3" class="col-sm-12 control-label"
							style="text-align: left;">上传付款凭证(图片上传过程中不能点击保存)</label>
						<div class="">
				...
				<div class="modal-footer" style="margin-top:-15px;">
					...
					<button type="button" class="btn btn-primary" onclick="submit();" id="submitPic">保存</button>
				</div>
	...
	<div class="modal fade" id="orderCloseReason" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- 开始 -->
					<form class="form-horizontal" id="dataFormOrder">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" id="quxiao1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="customerTrack">订单追踪</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
