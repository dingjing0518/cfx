...
<script src="./pageJs/operation/goodsmg/spec.js"></script>
<!-- 页面内容导航开始-->
</head>
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								<!-- 模态框 -->
								<button id="editable-sample_new" style="display:none;" showname="OPER_GOODS_SETTINGS_SPEC_BTN_ADD" class="btn btn-primary btn-new"
									data-toggle="modal" onclick="javascript:edit();">
									新增 <i class="fa fa-plus"></i>
								</button>
								<table id="specId" style="width: 100%"></table>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalLabel">编辑规格大类</h4>
				</div>
					...
					<input type="hidden" class="form-control" id="pk"/>
						<div class="form-group col-ms-12"
							...
							<label for="inputEmail3" class="col-sm-2 control-label"
								style="text-align: left;">规格名称</label>
							<div class="col-sm-10">
