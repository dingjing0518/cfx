...
<script src="./pageJs/operation/goodsmg/product.js"></script>
<!-- 页面内容导航开始	-->
</head>
<body class="sticky-header">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<header class="panel-heading" style="margin-bottom:10px;">
					     ...
					     <label class="col-lg-3 col-lg-2"><span>&nbsp;是否禁用：</span>
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								<!-- 模态框 -->
								<button id="editable-sample_new" style="display:none;" showname="OPER_GOODS_SETTINGS_NAME_BTN_ADD" class="btn btn-primary btn-new"
									data-toggle="modal" onclick="javascript:edit();">
									新增 <i class="fa fa-plus"></i>
								</button>
								<table id="productId" style="width: 100%"></table>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="editProductId" tabindex="-1" role="dialog"
					...
					<input type="hidden" class="form-control" id="pk"/>
						<div class="form-group col-ms-12"
							...
							<label for="inputEmail3" class="col-sm-2 control-label"
								style="text-align: left;">品名名称</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="name" required="true" maxlength="100"/>
							</div>
						</div>
						<div class="form-group col-ms-12"
							style="height: 30px; display: block;">
