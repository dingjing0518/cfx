...
<script src="./pageJs/operation/goodsmg/varieties.js"></script>
<!-- 页面内容导航开始-->
</head>
<body class="sticky-header">
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								<!-- 模态框 -->
								<button id="editable-sample_new" style="display:none;" showname="OPER_GOODS_SETTINGS_VARI_BTN_ADD" class="btn btn-primary btn-new"
									data-toggle="modal" onclick="javascript:edit();">
									新增 <i class="fa fa-plus"></i>
								</button>
								<table id="varietiesId" style="width: 100%"></table>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="editVarietiesId" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalLabel">编辑品种</h4>
				</div>
