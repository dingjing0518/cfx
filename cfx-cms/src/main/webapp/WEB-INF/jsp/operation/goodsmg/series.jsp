...
<script src="./pageJs/operation/goodsmg/series.js"></script>
<style>
#guige .help-block{
    margin-top: 0px;
    float: right;
...
<body class="sticky-header">
			...
			<div class="col-sm-12">
				...
				<header class="panel-heading" style="margin-bottom:10px;">
				  <label class="col-lg-3 col-lg-2"><span>规格大类：</span> 	
						    <select   name="parentPk" class="selectpicker bla bla bli"   data-live-search="true"  style="float:left;">
										...
										<div class="adv-table editable-table ">
											<div class="clearfix">
												<div class="btn-group" style="margin-bottom: 20px; width: 100%">
													<!-- 模态框 -->
													<button id="editable-sample_new" style="display:none;" showname="OPER_GOODS_SETTINGS_SERIES_BTN_ADD" class="btn btn-primary btn-new"
															data-toggle="modal" onclick="javascript:edit();">
									新增 <i class="fa fa-plus"></i>
								</button>
								<table id="seriesId" style="width: 100%"></table>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="editSeriesId" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalLabel">编辑规格系列</h4>
				</div>
				...
				<form id="dataForm">
					...
					<div class="form-group  col-ms-12" style="height: 30px;line-height:30px; display: block;">
						<label for="inputPassword3" class="col-sm-2 control-label">规格大类</label>
						<div class="col-sm-10" >
						<div class="form-controlselect" id="guige">
						 <select  name="parentPk" class="form-controlselect selectpicker bla bla bli" id="parentPk"   data-live-search="true"  required="true">
							   <option value="">--请选择--</option>
								<c:forEach items="${specList }" var="m">
								<option value="${m.pk}">${m.name }</option>
								</c:forEach>  
