...
<!-- 页面内容导航开始-->
<script src="./pageJs/operation/supplierBank.js"></script>
</head>
			...
			<div class="col-sm-12">
				...
				<header id = "header" class="panel-heading" > 
					     <input type="hidden" id="companyPk" name="companyPk"  value ="${companyPk}"/>
			              <button style="display:none;" showname="COMMON_CM_SUPPLIER_ACCOUNT_COMMON_BTN_ADD" class="btn btn-primary" id="btn" onclick="addBank()"> 新增银行</button>
