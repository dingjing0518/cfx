...
<script src="./pageJs/operation/opermg/priceTrend.js"></script>
<style>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<label class="col-lg-2 col-lg-3"><span>品种：</span> 	
						    ...
						    <select id="varietiesName" name="varietiesName"  class="selectpicker bla bla bli" data-live-search="true" onchange="changeVari()">
				...
				<label class="col-lg-2 col-lg-3"><span>规格大类：</span> 
		                	<select id="specName" name="specName" class="selectpicker bla bla bli"   data-live-search="true" onchange="changeSpec()">
								   <option value="">--请选择--</option>
				  ...
				  <label class="col-lg-2 col-lg-3"><span>厂家品牌：</span> 
			            ...
			            <button class="btn btn-primary" id="btn" onclick="SearchClean(1);"> 搜索</button>
			             ...
			             <button  style="display:none;" showname="OPER_MG_HOMESHOW_PRICE_BTN_EDITGOODS" class="btn btn-primary" id="btn" onclick="editGoods();">编辑商品</button>
			             <button  style="display:none;" showname="OPER_MG_HOMESHOW_PRICE_BTN_EXPORT" class="btn btn-primary" id="btn" onclick="exportPrice();">导出</button>
		...
		<div class="modal-dialog" role="document" style="width: 1000px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<input type="hidden" id="varietiesName1"/>
					<input type="hidden" id="specName1"/>
					<input type="hidden" id="seriesName1"/>
					<input type="hidden" id="specifications1"/>
					<input type="hidden" id="batchNumber1"/>
					<input type="hidden" id="brandName1"/>
