...
<script src="./pageJs/operation/opermg/homePageSpecBanner.js"></script>
<style>
	...
	<div class="wrapper">
		<div class="row">
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-sm-6 col-md-4 col-lg-3"><span>&nbsp;规格：</span>
						<select name="specPk" class="selectpicker bla bla bli">
							
							<option value="">--请选择--</option>
							<c:forEach  var ="c" items="${homePageSpecList }" >
		  ...
		  <button class="btn btn-primary" id="btn" onclick="Search();"> 搜索</button>
					...
					<button id="editable-sample_new" style="display:none;" showname="BTN_HOMEPAGE_SPEC_ADDBANNER" class="btn btn-primary"
				...
				<div class="panel-body">
					...
					<div class="panel-body">
						<div class="tab-content">
							...
							<table id="homePageSpecTableBannerId" style="width: 100%"></table>
						</div>
					</div>
					</section>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑首页规格</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="homePageSpec" id="homePageSpec" required="true">
									<option value="">--请选择--</option>
									<c:forEach  var ="c" items="${homePageSpecList }" >
										<option value="${c.pk }">${c.name }</option>
									</c:forEach>
