...
<script src="./pageJs/operation/opermg/friendLink.js"></script>
<style>
		...
		<div class="row">
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
				  ...
				  <label class="col-lg-2 col-lg-3"><span>&nbsp;网站名称：</span> 
		  ...
		  <button class="btn btn-primary" id="btn" onclick="Search();"> 搜索</button>
					...
					<button id="editable-sample_new" style="display:none;" showname="OPER_MG_HOMESHOW_LINK_BTN_ADD" class="btn btn-primary"
						data-toggle="modal" data-target="#myModal3"
						onclick="javascript:add(); ">新增</button>
				</a> </header>
				<div class="panel-body">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#all" data-toggle="tab"
							onclick="findKeyWordHot();">全部</a></li>
					</ul>
					</header> -->
					<div class="panel-body">
						<div class="tab-content">
							...
							<table id="friendLinkId" style="width: 100%"></table>
						</div>
					</div>
					</section>
				</div>
