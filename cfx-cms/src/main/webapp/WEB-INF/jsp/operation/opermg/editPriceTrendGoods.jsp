...
<script src="./pageJs/operation/opermg/editPriceTrendGoods.js"></script>
<style>
...
<body class="sticky-header">
	<div class="page-heading">
		...
		<li><a href="#">运营管理</a></li>
			...
			<li class="active">><a  href="#"  onclick="javascript:openFuturesPage('');">价格趋势</a></li>
		...
		<div class="row">
			<div class="col-sm-12">
				<section class="panel" style="width:48%;margin-right:2%;float:left;">
				 ...
				 <label class="col-lg-3 col-lg-4" style="padding:0px 7px;"><span>商品信息</span> <input class="form-controlgoods input-append " type="text" name="b2bGoodsInfo" id="b2bGoodsInfo"  value=""/></label>	
