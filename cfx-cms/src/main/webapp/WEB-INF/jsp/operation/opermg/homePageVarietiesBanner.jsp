...
<script src="./pageJs/operation/opermg/homePageVarietiesBanner.js"></script>
<style>
	...
	<div class="wrapper">
		<div class="row">
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-lg-3 col-lg-2"><span>&nbsp;品种：</span>
						<select name="varietiesPk" class="selectpicker bla bla bli">
							
							<option value="">--请选择--</option>
							<c:forEach  var ="c" items="${homePageVarietiesList }" >
		  ...
		  <button class="btn btn-primary" id="btn" onclick="Search();"> 搜索</button>
					...
					<button id="editable-sample_new" style="display:none;" showname="OPER_MG_HOMESHOW_VARI_BTN_ADD" class="btn btn-primary"
						data-toggle="modal" data-target="#editHomePageProductNameId"
						onclick="javascript:editHomePageVarietiesBanner('','','',''); ">添加品种</button>
				</a> </header>
				<div class="panel-body">
					...
					<div class="panel-body">
						<div class="tab-content">
							...
							<table id="homePageVarietiesTableBannerId" style="width: 100%"></table>
						</div>
					</div>
					</section>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑首页品种</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="homePageVarieties" id="homePageVarieties" required="true">
									<option value="">--请选择--</option>
									<c:forEach  var ="c" items="${homePageVarietiesList }" >
										<option value="${c.pk }">${c.name }</option>
									</c:forEach>
