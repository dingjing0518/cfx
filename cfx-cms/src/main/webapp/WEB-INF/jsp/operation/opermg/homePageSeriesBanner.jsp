...
<script src="./pageJs/operation/opermg/homePageSeriesBanner.js"></script>
<style>
...
<body class="sticky-header">
			...
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-lg-3 col-lg-2"><span>&nbsp;品名：</span>
						<select name="productnamePk" id="productnamePk" class="selectpicker bla bla bli" onchange="changeVirietiesName(this,1)">
							
							<option value="">--请选择--</option>
							<c:forEach  var ="c" items="${homePageProductNameOtherList }" >
							<option value="${c.pk }">${c.productName }</option>
							</c:forEach>
						</select> 
					</label>
					<label class="col-lg-3 col-lg-2"><span>&nbsp;品种：</span>
						<select name="varietiesPk" id="varietiesPk" class="selectpicker bla bla bli">
							<option value="">--请选择--</option>
						</select> 
					</label>
					...
					<label class="col-lg-3 col-lg-2"><span>&nbsp;规格：</span>
						<select id="specPk" name="specPk" class="selectpicker bla bla bli"  data-live-search="true" onchange="changeSpec(this,1)">
							<option value="">--请选择--</option>
							<c:forEach  var ="c" items="${homePageSeriesSpecList }" >
							<option value="${c.pk }">${c.name }</option>
							</c:forEach>
						</select> 
					</label>
					<label class="col-lg-3 col-lg-2"><span>&nbsp;规格系列：</span>
						<select name="seriesPk" id="seriesPk" class="selectpicker bla bla bli" data-live-search="true">
							<option value="">--请选择--</option>
						</select> 
					</label>
					...
					<button id="editable-sample_new" style="display:none;" showname="OPER_MG_HOMESHOW_SERIES_BTN_ADD" class="btn btn-primary"
						data-toggle="modal" data-target="#editHomePageProductNameId"
						onclick="javascript:editHomePageVarietiesBanner('','','',''); ">添加规格</button>
				</a> </header>
				<div class="panel-body">
					...
					<div class="panel-body">
						<div class="tab-content">
							...
							<table id="homePageSeriesTableBannerId" style="width: 100%"></table>
						</div>
					</div>
					</section>
				</div>
	...
	<!-- 新建分类model -->
	<div class="modal fade" id="editHomePageVarietiesId" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑首页规格系列</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
					...
					<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="homePageProductName" id="homePageProductName" required="true" onchange="changeVirietiesName(this,2)">
									<option value="">--请选择--</option>
									<c:forEach  var ="c" items="${homePageProductNameList }" >
										<option value="${c.pk }">${c.productName }</option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="homePageVarietiesName" id="homePageVarietiesName" required="true" >
									<option value="">--请选择--</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
								<select id="homePageSpec" name="specPk" class="selectpicker bla bla bli"   data-live-search="true" onchange="changeSpec(this,2)">
								   <option value="">--请选择--</option>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">规格系列</label>
							<div class="col-sm-10">
								<select class="selectpicker bla bla bli" name="homePageSeries" id="homePageSeries"  data-live-search="true" >
									<option value="">--请选择--</option>
								</select>
							</div>
						</div>
