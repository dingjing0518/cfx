...
<script src="./pageJs/operation/opermg/homePageProductNameBanner.js"></script>
<style>
.checkbox-inline input[type="checkbox"] {
	margin-top: 5px;
}
.pm.open .open>.dropdown-menu,.chooseslect.open .open>.dropdown-menu {
    display: none;
}
</style>
<!-- 页面内容导航开始-->
...
<body class="sticky-header">
		...
		<div class="row">
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-lg-3 col-lg-2 pm"><span>&nbsp;品名：</span>
						<select name="productPk" class="selectpicker bla bla bli">
					...
					<label class="col-lg-3 col-lg-2 chooseslect"><span>&nbsp;是否启用：</span>
		  ...
		  <button class="btn btn-primary" id="btn" onclick="Search();"> 搜索</button>
					...
					<button id="editable-sample_new" style="display:none;" showname="OPER_MG_HOMESHOW_NAME_BTN_ADD" class="btn btn-primary"
						data-toggle="modal" data-target="#editHomePageProductNameId"
						onclick="javascript:editHomePageProductNameBanner('','','',''); ">添加品名</button>
				</a> </header>
				<div class="panel-body">
					...
					<div class="panel-body">
						<div class="tab-content">
							...
							<table id="homePageProductNameTableBannerId" style="width: 100%"></table>
						</div>
					</div>
					</section>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑首页品名</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
					<form class="form-horizontal" id="dataForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="homePageProductName" id="homePageProductName" required="true">
									<option value="">--请选择--</option>
									<c:forEach  var ="c" items="${homePageProductList }" >
										<option value="${c.pk }">${c.name }</option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" autocomplete="off" name="sort" id="sort" required="true">
							</div>
						</div>
						<div class="form-group col-ms-12"
								style="height: 30px; display: block;">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
							<img  id="PURL" style='width:auto;height:80px;display: none'/>
	...
	$("#file").fileinput({
			...
			maxFileCount : 1, //同时最多上传3个文件 
			autoReplace:true,//是否替换当前图片
			 showUpload: true ,//是否显示上传按钮  
	         showRemove: false,//是否显示删除按钮  
	         showCaption: false,
	         fileActionSettings:{//上传图片上样式
	        	 showUpload: false,
	         },
