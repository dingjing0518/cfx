...
<script src="./pageJs/operation/opermg/homeThiredNavigation.js"></script>
<style>
		...
		<div class="row">
			<div class="col-sm-12">
				<section class="panel"> <header class="panel-heading"
					...
					<label class="col-sm-6 col-md-4 col-lg-3"><span>&nbsp;所属二级导航：</span>
						<select name="secondNavigationPk" class="selectpicker bla bla bli">
							<option value="">--请选择--</option>
				            	<c:forEach items="${secondNavigation }" var="m">
				            	<option value="${m.pk}">${m.navigation }</option>
				           	    </c:forEach>  
						</select> 
					</label>
					...
					<button id="editable-sample_new" style="display:none;" showname="OPER_MG_THIRDNAVIGATION_BTN_ADD" class="btn btn-primary"
			...
			<div class="modal-content">
				...
				<form   id="reasonForm">
					...
					<div class="form-group col-ms-12"
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="sortButton" name="sortButton" maxlength="20" required="true"/>
						</div>
					</div>
				</form>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑三级导航</h4>
				</div>
				<div class="modal-body">
					<!-- 开始 -->
					...
					<div class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">所属二级导航：</label>
							<div class="col-sm-9">
								<select class="form-control" name="secondNavigationPk" id="secondNavigationPk" required="true"onchange="changeThirdNavigation()">
									<option value="">--请选择--</option>
									<c:forEach items="${secondNavigation }" var="c">
										<option value="${c.pk }" data-code="${c.parentNavigation }">${c.navigation }</option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" name="navigationPk" id="navigationPk" required="true">
									<option value="">--请选择--</option>
								</select>
							</div>
						</div>
