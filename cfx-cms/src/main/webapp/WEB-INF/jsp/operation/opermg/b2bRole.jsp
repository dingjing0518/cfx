...
<script src="./pageJs/operation/opermg/b2bRole.js"></script>
<!-- 页面内容导航开始-->
</head>
					...
					<div class="adv-table editable-table ">
						<div class="clearfix">
							<div class="btn-group" style="margin-bottom: 20px; width: 100%">
								<!-- 模态框 -->
								<button id="editable-sample_new" style="display:none;" showname="OPER_MG_ROLE_BTN_ADD" class="btn btn-primary btn-new"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group col-ms-12"
						...
						<div class="col-sm-10">
							<input type="email" class="form-control" id="name" onmouseout="checkB2bRoleName(this.value);"><span id="namePrompt"></span>
							<input
					...
					<div class="form-group col-ms-12"
						...
						<div class="col-sm-10">
							<select id="companyType" class="form-control" name="companyType" onchange="changeRole(this)">
								<option value="1">化纤采购商</option>
								<option value="2">化纤供应商</option>
							</select>
						</div>
					</div>
					<div class="portlet light ">
						<div class="portlet-body">
							...
							<div id="treeId3" class="tree-demo" style="display: none;"></div>
							<div id="treeId4" class="tree-demo" style="display: none;"></div>
						</div>
					</div>
					<!-- 树形结束 -->
				</div>
