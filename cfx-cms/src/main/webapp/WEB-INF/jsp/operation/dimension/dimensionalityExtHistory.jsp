...
<script src="./pageJs/operation/dimension/dimensionalityExtHistory.js"></script>
<style>
				...
				<section class="panel">
				 ...
				 <label class="col-lg-2 col-lg-3" style="padding:0px 7px;"><span>公司名称：</span> <input class="form-controlgoods input-append " type="text" name="companyName" id="companyName"  value="" onkeydown="entersearch()"/></label>	
			            ...
			            <button style="margin-left:18px;position: relative;z-index: 10000;" class="btn btn-primary" id="btn" onclick="SearchClean(1);"> 搜索</button>
			             ...
			             <button  style="display:none;position: relative;z-index: 10000;" showname="OPER_MSS_GIVE_BTN_EXPORT" class="btn btn-primary" id="btn" onclick="exportPresent();">导出</button>
		             </header>
		             <!--  -->
