...
<script src="./pageJs/operation/dimension/dimensionalityExtreward.js"></script>
<style>
...
<body class="sticky-header">
				...
				<section class="panel">
				 <header class="panel-heading" style="margin-bottom:10px;" id="ewaijiangli">
			            ...
			            <button class="btn btn-primary" id="btn" onclick="SearchClean(1);"> 搜索</button>
			             ...
			             <button style="display:none;" showname="OPER_MSS_EXAWARD_BTN_ADD" class="btn btn-primary" id="btn" onclick="insertDimenReward();">新增</button>
		             </header>
	...
	<div class="modal fade" id="editDimensionalityREIdEx" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document" style="width:800px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalLabel">额外奖励</h4>
				</div>
			...
			<form id="dataForm">
					...
					<div class="form-group col-ms-12"
						...
						<div class="form-group col-ms-12"
							style="height: 30px; display: block;">
							<label for="inputEmail3" class="col-sm-2 control-label"
								style="text-align: left;">满足条件:</label>
							<div class="col-sm-4">
								<select  id="conditionType" name="conditionType" class="form-control bla bla bli"  style="width:220px;margin-left:0px" required="true" >
			   					<option value=''>--请选择--</option>
			   					</select>
		   					</div>
		   					<div class="col-sm-2">
		   						<input type="text" class="form-control" id="numberTimes" name="numberTimes" style="width:100px;margin-left:0px" />
		   					</div>
		   					<div class="col-sm-3">
			   					<select  id="util" name="util" class="form-control bla bla bli"  style="width:160px;margin-left:0px" required="true"  >
			   					<option value=''>--请选择--</option>
			   					</select>
							</div>
						</div>
						<div class="form-group col-ms-12"
							style="height: 30px; display: block;">
							<label for="inputEmail3" class="col-sm-2 control-label"
								style="text-align: left;">时间范围:</label>
							<div class="col-sm-6">
							<select  id="periodTime" name="periodTime" class="form-control bla bla bli"  style="width:280px;margin-left:0px" required="true" >
		   					<option value=''>--请选择--</option>
		   					</select>
							</div>
						</div>
						<div class="form-group col-ms-12"
							...
							<div class="col-sm-6">
							<select  id="periodType1" name="periodType1" class="form-control bla bla bli"  style="width:280px;margin-left:0px" required="true" >
		   					<option value=''>--请选择--</option>
		   					</select>
							</div>
						</div>
