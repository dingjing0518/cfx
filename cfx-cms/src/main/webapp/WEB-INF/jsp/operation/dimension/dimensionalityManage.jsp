...
<script src="./pageJs/operation/dimension/dimensionalityManage.js"></script>
<style>
...
<body class="sticky-header">
				...
				<section class="panel">
				 <header class="panel-heading" style="margin-bottom:10px;">
			            ...
			            <button class="btn btn-primary" id="btn" onclick="SearchClean(1);"> 搜索</button>
			             ...
			             <button style="display:none;" showname="OPER_MSS_DIMENSION_BTN_ADD" class="btn btn-primary" id="btn" onclick="insertDimensionality();">新增</button>
	...
	<div class="modal fade" id="editDimensionalityId" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document" style="width:800px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalLabel">维度编辑</h4>
				</div>
			...
			<form id="dataForm">
					...
					<input type="hidden" class="form-control" id="pk" />
						<div class="form-group col-ms-12"
							...
							<div class="col-sm-6">
							<select  id="name" name="name" class="form-control bla bla bli"  style="width:280px;margin-left:0px" required="true">
		   					</select>
							</div>
						</div>
						 <!-- 编辑页面结束 -->
