...
<script src="./pageJs/auctionDetail.js"></script>
<!-- 页面内容导航开始-->
<style>
	...
	<div class="wrapper">
		<div class="row">
			...
			<section class="panel">
		        ...
		        <form id="dataForm">
		        <input type="hidden" id="ruleTypeId" value="${ruleType}"/>
		        <input type="hidden" id="pk" value="${protocolRuleDto.pk}"/>
