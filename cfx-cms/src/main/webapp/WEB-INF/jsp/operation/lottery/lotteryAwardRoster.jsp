...
<script src="./pageJs/operation/lottery/lotteryAwardRoster.js"></script>
<!-- 页面内容导航开始-->
<style>
		...
		<div class="row">
			<div class="col-sm-12">
				<section class="panel">
				 ...
				 <label class="col-lg-2 col-lg-3"><span>获奖时间：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="insertTimeStart"   value="" readonly /></label>
			   			...
			   			<label class="col-lg-2 col-lg-3"><span>注册手机号：</span> <input class="form-controlgoods input-append " type="text" name="mobile"   value="" /></label>
		   				<label class="col-lg-2 col-lg-3"><span>活动类型：</span> 
			 				<select  name="activityType" class="selectpicker bla bla bli">
			   			...
			   			<label class="col-lg-2 col-lg-3"><span>姓名：</span> <input class="form-controlgoods input-append " type="text" name="memberName"   value="" /></label>
			            <input type="hidden" id="isAwardStatus" name="isAwardStatus" />
			            <div>
			            <label class="col-lg-2 col-lg-3">
			           	 	<input class="col-sm-3 col-md-2 col-lg-2" type="file" id="updateFile" value="" style="width:130px"/>
			            	<button style="display:none;" showname="OPER_ACTIVITY_LOTTERY_ROSTER_BTN_IMPORT" class="btn btn-default dropdown-toggle" onclick="importLotteryRoster();">导入</button>
			            </label>
			            <button style="display:none;" showname="OPER_ACTIVITY_LOTTERY_ROSTER_BTN_EXPORT" class="btn btn-default dropdown-toggle" onclick="exportAwardRoster();" data-toggle="dropdown">
			            <span id="loadingExportAwardData">导出</span></button>
					...
					<section class="panel">
                        <header class="panel-heading custom-tab ">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="">
                                    <a href="#verify" data-toggle="tab" onclick="findGoodsbrand(1);">未发放</a>
                                </li>
                                <li class="">
                                    <a href="#verifydone" data-toggle="tab" onclick="findGoodsbrand(2);">已发放</a>
                                </li>
		...
		<div class="modal-dialog" role="document">
			...
			<form id="dataForm">
					...
					<div class="form-group col-ms-12"
							...
							<div class="col-sm-4">
							<select class="form-control col-sm-2" id="awardStatus"  name="awardStatus" required="true" style="float:none;" onchange="changeAwardStatus()">
					...
					<div class="form-group col-ms-12"
							...
							<div class="col-sm-4">
							<select class="form-control col-sm-2" id="grantType"  name="grantType" required="true" style="float:none;">
