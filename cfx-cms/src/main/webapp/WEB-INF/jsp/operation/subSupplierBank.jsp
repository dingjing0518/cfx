...
<!-- 页面内容导航开始-->
<script src="./pageJs/operation/subSupplierBank.js"></script>
</head>
			...
			<div class="col-sm-12">
				...
				<header id = "header" class="panel-heading" > 
					     <input type="hidden" id="companyPk" name="companyPk"  value ="${companyPk}"/>
			              <button style="display:none;" showname="COMMON_CM_SUPPLIER_ACCOUNT_SUBSUP_BTN_ADD" class="btn btn-primary" id="btn" onclick="addBank()"> 新增银行</button>
					<input type="hidden" id="isCompanyType" name="isCompanyType" value="${isCompanyType}"/>
		...
		<div class="modal-dialog" role="document" style="width: 1000px;">
			<div class="modal-content">
				...
				<form id="creditDataForm">
					<input type="hidden" id="companyBankCardPk" name="companyBankCardPk" />
					<!-- 树形 -->
					<div class="form-group col-ms-12"
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="creditCompanyName" name="creditCompanyName" value = "${companyName}"style="width: 342px;" readonly="readonly"/>
						</div>
					</div>
