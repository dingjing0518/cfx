...
<script src="./pageJs/operation/operationCentreReport/bussStoreData.js"></script>
<style>
...
<body class="sticky-header">
	<div class="page-heading">
		<ul class="breadcrumb">
			<li><a href="#">运营中心</a></li>
			<li class="active">数据管理>交易数据>店铺日交易数据</li>
		</ul> 
	</div>
	<!-- 页面内容导航结束-->
	<!--主体内容开始-->
			...
			<div class="col-sm-12">
				<section class="panel">
				 	<header class="panel-heading" style="margin-bottom:10px;">
					 	<label class="col-lg-2 col-lg-3" style="padding:0px 7px;"><span>店铺名称：</span> <input class="form-controlgoods input-append " type="text" name="storeName" id="storeName"  value="" onkeydown="entersearch()"/></label>	
			            ...
			            <button  style="position: relative;z-index: 10000;display: none;" showname="OPER_REPORTFORMS_TRANS_STORENUM_BTN_EXPORT" class="btn btn-primary" id="btn" onclick = "exportReport();">导出</button>
	             	</header>
		             <!--  -->
					...
					<section class="panel">
                        <div class="bootstrap-table" style="margin-top:10px;">
                            <div class="tab-content">
                                ...
                                <table id="bussStoreData" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
