...
<script src="./pageJs/operation/operationCentreReport/flowData.js"></script>
<style>
			...
			<div class="col-sm-12">
				<section class="panel">
				 	<header class="panel-heading" style="margin-bottom:10px;" id="ewaijiangli">
			            ...
			            <button  style="position: relative;z-index: 10000;display: none;" showname="OPER_REPORTFORMS_FLOW_BTN_EXPORT" class="btn btn-primary" id="btn"  onclick = "exportPresent();">导出</button>
	             	</header>
		             <!--  -->
					...
					<section class="panel">
                        <div class="bootstrap-table" style="margin-top:10px;">
                            <div class="tab-content">
                                ...
                                <table id="flowData" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
