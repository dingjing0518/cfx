...
<script src="./pageJs/operation/operationCentreReport/bussOverview.js"></script>
<style>
...
.bootstrap-table,table#memberData {width:3183px;}
...
<body class="sticky-header">
	<div class="page-heading">
		<ul class="breadcrumb">
			<li><a href="#">运营中心</a></li>
			<li class="active">数据管理>交易数据>交易总览</li>
		</ul> 
	</div>
	<!-- 页面内容导航结束-->
	<!--主体内容开始-->
			...
			<div class="col-sm-12">
				<section class="panel">
				 	<header class="panel-heading" style="margin-bottom:10px;" id="ewaijiangli">
						...
						<label class="col-lg-2 col-lg-3" style="padding:0px 7px;"><span>日期：</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="countTimeStart" id="countTimeStart"  value="" readonly /></label>
				        <label class="col-lg-2 col-lg-3" style="padding:0px 7px;"><span>至</span> <input class="form-controlgoods input-append date form-dateday" type="text" name="countTimeEnd"  id="countTimeEnd"  value="" readonly /></label>
			            ...
			            <button  style="position: relative;z-index: 10000;display: none;" showname="OPER_REPORTFORMS_TRANS_VIEW_BTN_EXPORT" class="btn btn-primary" id="btn" onclick="exportPresent();">导出</button>
	             	</header>
		             <!--  -->
					...
					<section class="panel">
                        <div class="" style="margin-top:10px;">
                            <div class="tab-content">
                                ...
                                <table id="bussOverview" style="width: 100%"></table>
                            </div>
                        </div>
                    </section>
				</div>
