...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.clearBtn = (options.clearBtn || this.element.data('date-clear-btn') || false);//添加部分
	...
	Datetimepicker.prototype = {
		...
		fill: function() {
			...
			this.picker.find('.datetimepicker-days thead th:eq(1)')
				...
				this.picker.find('tfoot th.clear').text(dates[this.language].clear).toggle(this.clearBtn!==false);//添加部分
			this.updateNavArrows();
			this.fillMonths();
