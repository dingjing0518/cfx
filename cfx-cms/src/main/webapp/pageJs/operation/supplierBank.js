...
var columns = [
		{
			...
			formatter : function(value, row, index) {
				...
				str += '<button type="button" onclick="javascript:del(\''
						+ value
						+ '\'); " style="display:none;" showname="COMMON_CM_SUPPLIER_ACCOUNT_COMMON_BTN_DEL" class="btn btn-danger active">删除</button>';
				str += '<button style="display:none;" id="editable-sample_new" showname="COMMON_CM_SUPPLIER_ACCOUNT_COMMON_BTN_EDIT" class="btn btn-primary" data-toggle="modal"  onclick="javascript:edit(\''
						+ value
						+ '\',\''
						+ row.ecbankPk
						+ '\',\''
 ...
 * @param bankAccount
 */
function edit(pk, ecbankPk, ecbankName, bankName, bankNo, bankclscode,bankAccount) {
