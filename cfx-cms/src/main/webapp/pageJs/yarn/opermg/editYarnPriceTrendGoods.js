...
var columnsGoods = [ {
					...
					formatter : function(value, row, index) {
						var str = "";
							str += ' <a class="save" href="javascript:;" style="text-decoration:none;"> <button type="button" style="display:none;" showname="YARN_MG_HOMESHOW_PRICE_EDITGOODS_BTN_ADD" class="btn btn-warning" onclick="javascript:isAdd(\''
									+ value+ '\');">添加</button></a>';
						return str;
					}
				}
...
var columnsPrice = [ {
					...
					formatter : function(value, row, index) {
						var str = "";
							str += ' <a class="save" href="javascript:;" style="text-decoration:none;"> <button type="button" style="display:none;" showname="YARN_MG_HOMESHOW_PRICE_EDITGOODS_BTN_REMOVE" class="btn btn-warning" onclick="javascript:isDelete(\''
									+ value+ '\');">移出</button></a>';
						return str;
					}
				}
...
function isAdd(pk){
	...
	$.ajax({
		type : 'POST',
		url : './insertSxGoodsPriceTrend.do',
		data : {
			 pk : pk
		},
		dataType : 'json',
