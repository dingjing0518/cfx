 ...
 */
function deal(economCustPk,taskId,processInstanceId){

	window.location.href = getRootPath()+"/redirectPage.do?taskId="+taskId+"&economCustPk="+economCustPk+"&processInstanceId="+processInstanceId;
