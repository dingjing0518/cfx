...
public interface B2bRoleExtDao extends B2bRoleDao{
	...
	List<B2bRoleDto> getRoleByMember(Map<String, Object> map);

    List<B2bRoleExtDto> searchRoles(Map<String, Object> map);
