...
//		String src = "{\"token\":\"A325C571C8027E9DEC3CFC6B296A19D0\",\"purchaserPk\":\"8feae138c62a4a439568763aa95cf019\",\"organizationCode\":\"987546727828282992\"}";
		...
		String endo="ZWRobW1waGVvZmpvZWNka2VsZmdibmFrMXZ4V0xRZ3ZkdnRjdmxnU3ZWN3ZZTk9IeXRRaEJ3b0FPbnp4N3RCcnV5UkNHOHNUM0pibWRMeE9zM3k0b2ZjUUx6TG9jL2FLTFJJRmpET3hQS3I0Q3hUSkIyKzBCMkZBQWdHLytFQVg1UE44RFhiWWtnWFlqSTNIRTBxOWowMWc=";
//		String[] result = des3Decrypt3Base64(endo);
        ...
        substring="PXzf33bS+oqvVCH8kB5eSg==";

        byte[] temp1 = base64DecodeToBytes(substring);
        String s1 = new String(des3Decrypt(temp1, key),
                DEFAULT_CHARSET);
