...
public class HTTPAspect {
    ...
    @Pointcut("execution(* cn.cf.controller.*.*(..)) && !execution(* cn.cf.controller.NoticeController.*(..)) " +
    		"&& !execution(* cn.cf.controller.CreditController.exportFinancesList(..))" +
    		"&& !execution(* cn.cf.controller.CreditController.jumpLoanPage(..))" +
    		"&& !execution(* cn.cf.controller.NoticeEconomicsController.*(..))")
    public void code() {
