 ...
 * @since 1.0
 * */
public class C2bMarrieddeal implements java.io.Serializable{
    ...
    public static int MARRIEDDEAL_BIDING = 9;
    public static int MARRIEDDEAL_BIDED = 2;
    public static int MARRIEDDEAL_FINISHED = 1;
    public static int MARRIEDDEAL_CLOSED = 0;
