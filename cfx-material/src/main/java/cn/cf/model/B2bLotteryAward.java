 ...
 * @since 1.0
 * */
public class B2bLotteryAward extends BaseModel implements java.io.Serializable{
	...
	public B2bLotteryAward(){}

	public B2bLotteryAward(B2bLotteryAwardDto dto){
		this.pk = dto.getPk();
		this.activityPk = dto.getActivityPk();
		this.name = dto.getName();
		this.awardType = dto.getAwardType();
		this.awardVariety = dto.getAwardVariety();
		this.awardName = dto.getAwardName();
		this.relevancyPk = dto.getRelevancyPk();
		this.amount = dto.getAmount();
		this.awardPercent = dto.getAwardPercent();
		this.insertTime = dto.getInsertTime();
		this.updateTime = dto.getUpdateTime();
		this.isDelete = dto.getIsDelete();
		this.isVisable = dto.getIsVisable();
		this.awardRule = dto.getAwardRule();
		this.status = dto.getStatus();
		this.awardSort = dto.getAwardSort();
		this.showSort = dto.getShowSort();
		this.startTime = dto.getStartTime();
		this.endTime = dto.getEndTime();
		this.packageNumber = dto.getPackageNumber();
