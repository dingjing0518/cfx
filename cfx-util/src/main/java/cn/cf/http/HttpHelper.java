...
public class HttpHelper {
	...
	public static String doPost(String url, Map<String, String> paraMap,String type) {
		return doPost(url, null, paraMap, type);
	}
...
//		}
	...
	public static void exeAsyncReqForJson(String baseUrl, boolean isPost,  
            List<BasicNameValuePair> urlParams,  
            String postBody, FutureCallback callback)  
            throws Exception {  
		if (baseUrl == null) {
	...
	public static String customizePost(String url, String str,Header[] headers,String contentType){
		String result="";
		if (url == null || url.length() <= 0) {
		} else {
			HttpResponse response = null;
