...
//		String src = "{\"jsonData\":{\"orderNumber\":\"201710301420164966250\",\"items\":[{\"childOrderNumber\":\"201710301420164965699\",\"boxesShipped\":34,\"weightShipped\":34343.22},{\"childOrderNumber\":\"201710301420164978545\",\"boxesShipped\":34,\"weightShipped\":34343.22}]}}";
		String src = 	"{\"jsonData\":{\"appId\":\"f6c2b27111f0dfe9dfbf7075c76f521a\",\"appSecret\":\"ab2236b29c0821133839ab5845af4b2c\"}}";
		System.out.println("src" + src);
		//内容加密编码
		String encode = des3Encrypt3Base64(src);
		System.out.println("eeeeeeeeeeeeeeeeeeeeeeeeee:"+encode);
		//加密后解码

		String endo="ZXBta2RiampvbG9naGlnZGZkamRqbmNiWFdJRXJKdDI5RlBjYU1SOFNpZDFwdWg2VXV0cmNmWXNsMzdyekkyQmNIWEtxY1FCcXlrLzBTc1pPY3R5RW11dUk3UFM5ZnhrblFJaEhaa2FONTdtVS8yTWRlbXluK0NPRm9STVlTZmdGV2ZKVjE0cnhVLzNVS0o5UHN4eDFMV05Hb0FiQTh4c1JJVEFwVUlBeXdydW1STC8weXRGNDZsaw==";
		String[] result = des3Decrypt3Base64(endo);
		System.out.println("ddddddddddddddddddddddddddddd:"+result[1]);
//        String s = base64Decode(endo);
//        System.out.println(s);
//        System.out.println(s.substring(0,24));
//        String key = s.substring(0, 24);
//        String substring = s.substring(24);
//        System.out.println(substring);
//
//        substring="e1qS5PFtfDo=";
//
//        byte[] temp1 = base64DecodeToBytes(substring);
//      System.out.println(temp1);
//        byte[] bytes = des3Decrypt(temp1, key);
//        System.out.println(bytes.toString());
//
//        String s1 = new String(des3Decrypt(temp1, key), DEFAULT_CHARSET);
