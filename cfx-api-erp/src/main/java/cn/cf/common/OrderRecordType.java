...
public enum OrderRecordType {
	...
	public String toString() {
		switch (this.code) {
		case 1:
			return "创建订单成功,订单号:${orderNumber}  ";
		case 2:
			return "订单支付成功,订单号:${orderNumber}  ";
		case 3:
			return "订单更新成功,";
		case 4:
			return "订单还款记录,订单号:${orderNumber}  ";
		case 5:
			return "订单部分发货,订单号:${orderNumber}  ";
		case 6:
			return "订单商品均已全部发货,订单号:${orderNumber}  请查收  ";
		case 7:
			return "创建合同成功,合同号:${orderNumber}  ";
		case 8:
			return "合同支付成功,合同号:${orderNumber}  ";
		case 9:
			return "合同更新成功,";
		case 10:
			return "合同还款记录,合同号:${orderNumber}  ";
		case 11:
			return "合同部分发货,合同号:${orderNumber}  ";
		case 12:
			return "合同商品均已全部发货,合同号:${orderNumber}  请查收  ";
		default:
			return "";
		}
	}
